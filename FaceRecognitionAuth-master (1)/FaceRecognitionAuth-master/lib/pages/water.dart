...
class _waterState extends State<water> {
  ...
  String dropdown = 'Cairo Water';
  var items = ['Cairo Water','Giza Water','Red Sea Water','Matrouh Water','Alex Water','Sohag Water','Beni Suef Water'];
  ...
  Future SendData() async {
    ...
    var url = Uri.parse('https://inconspicuous-pairs.000webhostapp.com/water.php') ;
  ...
  Future SendData2(var date,var time) async {
    ...
    final encTooo = base64Encode(aes.encrypt(Uint8List.fromList(utf8.encode(dropdown))));
    final encType = base64Encode(aes.encrypt(Uint8List.fromList(utf8.encode('Water'))));
    final encAmount = base64Encode(aes.encrypt(Uint8List.fromList(utf8.encode(amount.text))));
          ...
          ListView(
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  SizedBox(height: 40),
                  Center(child: Text('Water'.tr,style: TextStyle(fontSize: 19,fontWeight: FontWeight.bold),)),
                  SizedBox(height: 40),
                  Row(children: [
                    Container(
                  ...
                  Row(children: [
                    Container(
                      padding: EdgeInsets.only(left: 50),
                      child: Text('Mobile number'.tr,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold)),
                    ),
                  ],),
                  Container(
                    width: 310,
                  ...
                  Container(
                      ...
                      child: ClipRRect(
                        child: SizedBox(height: 50, child:  ElevatedButton(
                          ...
                          onPressed: () async {
                            setState(() {
                              if(number.text!=''&&amount.text!=''&&pass!='')
                              {
                                if(pass.text==pass2) {
